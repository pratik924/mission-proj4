	...
	<div align="center">
		...
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>College Name : </b></label><%=HTMLUtility.getList("Id", String.valueOf(bean.getId()), collegeList)%>
						&emsp; <label><b>City :</b></label> <input type="text" name="city"
